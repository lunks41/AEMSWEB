...
namespace AEMSWEB.Areas.Master.Data.IServices
{
    public interface IChargesService
    {
        ...
        public Task<M_Charges> GetChargesByIdAsync(short CompanyId, short UserId, short ChargeId);

        public Task<SqlResponse> SaveChargesAsync(short CompanyId, short UserId, M_Charges M_Charges);

        public Task<SqlResponse> DeleteChargesAsync(short CompanyId, short UserId, M_Charges M_Charges);
    }
}