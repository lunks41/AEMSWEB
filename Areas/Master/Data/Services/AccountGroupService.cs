...
namespace AMESWEB.Areas.Master.Data.Services
{
    public sealed class AccountGroupService : IAccountGroupService
    {
        ...
        public async Task<SqlResponce> SaveAccountGroupAsync(short CompanyId, short UserId, M_AccountGroup m_AccountGroup)
        {
            using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
            {
                ...
                try
                {
                    ...
                    if ((codeExist?.IsExist ?? 0) > 0)
                        return new SqlResponce { Result = -1, Message = "AccGroup Code already exists." };
                    ...
                    if ((nameExist?.IsExist ?? 0) > 0)
                        return new SqlResponce { Result = -1, Message = "AccountGroup Name already exists." };
                    ...
                    if (IsEdit)
                    {
                        ...
                        {
                            return new SqlResponce { Result = -1, Message = "AccountGroup Not Found" };
                        }
                    }
                    else
                    {
        ...
        public async Task<SqlResponce> DeleteAccountGroupAsync(short CompanyId, short UserId, short accGroupId)
        {
