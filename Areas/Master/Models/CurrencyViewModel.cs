...
namespace AEMSWEB.Models.Masters
{
    ...
    public class SaveCurrencyDtViewModel
    {
        public CurrencyDtViewModel currencyDt { get; set; }
        public string? companyId { get; set; }
    }
    ...
    public class SaveCurrencyLocalDtViewModel
    {
        public CurrencyLocalDtViewModel currencyLocalDt { get; set; }
        public string? companyId { get; set; }
    }
