        ...
        public async Task<IActionResult> Save([FromBody] SaveChartOfAccountViewModel model)
        {
            ...
            try
            {
                var chartToSave = new M_ChartOfAccount
                {
                    ...
                    IsDeptMandatory = model.chartOfAccount.IsDeptMandatory,
                    IsBargeMandatory = model.chartOfAccount.IsBargeMandatory,
                    IsJobOrderMandatory = model.chartOfAccount.IsJobOrderMandatory,
                    IsBankCharges = model.chartOfAccount.IsBankCharges,
