...
namespace AEMSWEB.Services.Admin
{
    public sealed class DocumentService : IDocumentService
    {
        ...
        public async Task<IEnumerable<DocumentViewModel>> GetDocumentByIdAsync(Int16 CompanyId, Int16 ModuleId, Int16 TransactionId, Int64 DocumentId, Int16 UserId)
        {
            try
            {
        ...
        public async Task<SqlResponse> SaveDocumentAsync(Int16 CompanyId, AdmDocuments admDocuments, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> DeleteDocumentAsync(Int16 CompanyId, Int16 ModuleId, Int16 TransactionId, Int64 DocumentId, Int32 ItemNo, Int16 UserId)
        {
            using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
            {
