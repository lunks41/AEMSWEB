...
namespace AEMSWEB.Services.Admin
{
    public sealed class TransactionService : ITransactionService
    {
        ...
        public async Task<IEnumerable<TransactionViewModel>> GetUsersTransactionsAsync(Int16 CompanyId, Int16 ModuleId, Int16 UserId)
        {
        ...
        public async Task<IEnumerable<TransactionViewModel>> GetUsersTransactionsAllAsync(Int16 CompanyId, Int16 UserId)
        {
            var parameters = new DynamicParameters();
            try
            {
        ...
        public async Task<IEnumerable<TransactionViewModel>> GetUsersTransactionsAllAsyncV1(Int16 CompanyId, Int16 UserId)
        {
            var parameters = new DynamicParameters();
        ...
        public async Task<List<GroupViewModel>> GetMenuListAsync(Int16 CompanyId, Int16 UserId)
        {
