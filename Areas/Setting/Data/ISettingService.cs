...
namespace AEMSWEB.Areas.Setting.Data
{
    public interface ISettingService
    {
        ...
        public Task<decimal> GetExchangeRateAsync(short CompanyId, short UserId, Int16 CurrencyId, string TrnsDate);
        ...
        public Task<MandatoryFieldsViewModel> GetMandatoryFieldsByIdAsync(short CompanyId, short UserId, Int16 ModuleId, Int16 TransactionId);
