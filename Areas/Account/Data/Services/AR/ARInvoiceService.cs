...
namespace AEMSWEB.Areas.Account.Data.Services.AR
{
    public sealed class ARInvoiceService : IARInvoiceService
    {
        ...
        public async Task<ARInvoiceViewModelCount> GetARInvoiceListAsync(short CompanyId, short UserId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate)
        {
        ...
        public async Task<ARInvoiceViewModel> GetARInvoiceByIdNoAsync(short CompanyId, short UserId, long InvoiceId, string InvoiceNo)
        {
        ...
        public async Task<SqlResponse> SaveARInvoiceAsync(short CompanyId, short UserId, ArInvoiceHd arInvoiceHd, List<ArInvoiceDt> arInvoiceDt)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteARInvoiceAsync(short CompanyId, short UserId, long InvoiceId, string CanacelRemarks)
        {
        ...
        public async Task<IEnumerable<ARInvoiceViewModel>> GetHistoryARInvoiceByIdAsync(short CompanyId, short UserId, long InvoiceId, string InvoiceNo)
        {
            try
            {
        ...
        public async Task<ARInvoiceViewModel> GetHistoryARInvoiceByIdAsync_V1(short CompanyId, short UserId, long InvoiceId, string InvoiceNo)
        {
            ARInvoiceViewModel aRInvoiceViewModel = new ARInvoiceViewModel();
            try
            {
