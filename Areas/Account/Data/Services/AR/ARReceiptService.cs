...
namespace AEMSWEB.Areas.Account.Data.Services.AR
{
    public sealed class ARReceiptService : IARReceiptService
    {
        ...
        public async Task<ARReceiptViewModelCount> GetARReceiptListAsync(short CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, short UserId)
        {
