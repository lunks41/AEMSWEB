...
namespace AEMSWEB.Services.Accounts.CB
{
    public sealed class CBGenPaymentService : ICBGenPaymentService
    {
        ...
        public async Task<CBGenPaymentViewModel> GetCBGenPaymentListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<CBGenPaymentHdViewModel> GetCBGenPaymentByIdNoAsync(Int16 CompanyId, Int64 PaymentId, string PaymentNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveCBGenPaymentAsync(Int16 CompanyId, CBGenPaymentHd CBGenPaymentHd, List<CBGenPaymentDt> CBGenPaymentDt, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteCBGenPaymentAsync(Int16 CompanyId, Int64 PaymentId, string CanacelRemarks, Int16 UserId)
        {
        ...
        public async Task<IEnumerable<CBGenPaymentHdViewModel>> GetHistoryCBGenPaymentByIdAsync(Int16 CompanyId, Int64 PaymentId, string PaymentNo, Int16 UserId)
        {
            try
            {
