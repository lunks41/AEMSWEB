...
namespace AEMSWEB.Services.Accounts.CB
{
    public sealed class CBBankTransferService : ICBBankTransferService
    {
        ...
        public async Task<CBBankTransferViewModelList> GetCBBankTransferListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, Int16 UserId)
        {
        ...
        public async Task<CBBankTransferViewModel> GetCBBankTransferByIdNoAsync(Int16 CompanyId, Int64 TransferId, string TransferNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveCBBankTransferAsync(Int16 CompanyId, CBBankTransfer CBBankTransfer, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteCBBankTransferAsync(Int16 CompanyId, Int64 TransferId, string TransferNo, string CanacelRemarks, Int16 UserId)
        {
            try
            {
                using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
        ...
        public async Task<IEnumerable<CBBankTransferViewModel>> GetHistoryCBBankTransferByIdAsync(Int16 CompanyId, Int64 TransferId, string TransferNo, Int16 UserId)
        {
            try
            {
