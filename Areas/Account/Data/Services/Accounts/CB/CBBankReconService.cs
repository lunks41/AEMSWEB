...
namespace AEMSWEB.Services.Accounts.CB
{
    public sealed class CBBankReconService : ICBBankReconService
    {
        ...
        public async Task<CBBankReconHdViewModel> GetCBBankReconByIdNoAsync(Int16 CompanyId, Int64 ReconId, string ReconNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveCBBankReconAsync(Int16 CompanyId, CBBankReconHd CBBankReconHd, List<CBBankReconDt> CBBankReconDt, Int16 UserId)
        {
            bool IsEdit = false;
            ...
            try
            {
                using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                {
                    ...
                    if (IsEdit)
                    {
                        var dataExist = await _repository.GetQueryAsync<SqlResponseIds>($"SELECT 1 AS IsExist FROM dbo.CBBankReconHd WHERE IsCancel=0 And CompanyId={CompanyId} And ReconId={CBBankReconHd.ReconId}");
                    ...
                    if (!IsEdit)
                    {
                        var documentIdNo = await _repository.GetQueryAsync<SqlResponseIds>($"exec S_GENERATE_NUMBER_NOANDID {CompanyId},{(short)E_Modules.CB},{(short)E_CB.CBBankRecon},'{accountDate}'");
                    ...
                    {
                        await _repository.GetQueryAsync<SqlResponseIds>($"exec FIN_CB_CreateHistoryRec {CompanyId},{UserId},{CBBankReconHd.ReconId},{(short)E_CB.CBBankRecon}");
                    }
                    ...
                    if (SaveHeader > 0)
                    {
                        ...
                        if (SaveDetails > 0)
                        {
                            ...
                            await _repository.GetQueryAsync<SqlResponseIds>($"exec FIN_CB_CreateStatement {CompanyId},{UserId},{CBBankReconHd.ReconId},{(short)E_CB.CBBankRecon}");
        ...
        public async Task<SqlResponse> DeleteCBBankReconAsync(Int16 CompanyId, Int64 ReconId, string CanacelRemarks, Int16 UserId)
        {
                ...
                using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                {
                    ...
                    if (ReconId > 0)
                    {
                        ...
                        if (CBBankReconToRemove > 0)
                        {
                            ...
                            await _repository.GetQueryAsync<SqlResponseIds>($"exec FIN_CB_DeleteStatement {CompanyId},{UserId},{ReconId},{(short)E_CB.CBBankRecon}");
        ...
        public async Task<IEnumerable<CBBankReconHdViewModel>> GetHistoryCBBankReconByIdAsync(Int16 CompanyId, Int64 ReconId, string ReconNo, Int16 UserId)
        {
            try
            {
        ...
        public async Task<CBBankReconHdViewModel> GetHistoryCBBankReconByIdAsync_V1(Int16 CompanyId, Int64 ReconId, string ReconNo, Int16 UserId)
        {
            CBBankReconHdViewModel CBBankReconHdViewModel = new CBBankReconHdViewModel();
            try
            {
