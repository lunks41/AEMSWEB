...
namespace AEMSWEB.Services.Accounts.AR
{
    public sealed class ARCreditNoteService : IARCreditNoteService
    {
        ...
        public async Task<ARCreditNoteViewModelCount> GetARCreditNoteListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<ARCreditNoteViewModel> GetARCreditNoteByIdAsync(Int16 CompanyId, Int64 CreditNoteId, string CreditNoteNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveARCreditNoteAsync(Int16 CompanyId, ArCreditNoteHd arCreditNoteHd, List<ArCreditNoteDt> arCreditNoteDt, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteARCreditNoteAsync(Int16 CompanyId, Int64 CreditNoteId, string CanacelRemarks, Int16 UserId)
        {
        ...
        public async Task<IEnumerable<ARCreditNoteViewModel>> GetHistoryARCreditNoteByIdAsync(Int16 CompanyId, Int64 CreditNoteId, string CreditNoteNo, Int16 UserId)
        {
            try
            {
        ...
        public async Task<ARCreditNoteViewModel> GetHistoryARCreditNoteByIdAsync_V1(Int16 CompanyId, Int64 CreditNoteId, string CreditNoteNo, Int16 UserId)
        {
            ARCreditNoteViewModel aRCreditNoteViewModel = new ARCreditNoteViewModel();
            try
            {
