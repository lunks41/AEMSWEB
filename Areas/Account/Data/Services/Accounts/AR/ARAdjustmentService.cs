...
namespace AEMSWEB.Services.Accounts.AR
{
    public sealed class ARAdjustmentService : IARAdjustmentService
    {
        ...
        public async Task<ARAdjustmentViewModelCount> GetARAdjustmentListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<ARAdjustmentViewModel> GetARAdjustmentByIdAsync(Int16 CompanyId, Int64 AdjustmentId, string AdjustmentNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveARAdjustmentAsync(Int16 CompanyId, ArAdjustmentHd arAdjustmentHd, List<ArAdjustmentDt> arAdjustmentDt, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteARAdjustmentAsync(Int16 CompanyId, Int64 AdjustmentId, string CanacelRemarks, Int16 UserId)
        {
        ...
        public async Task<IEnumerable<ARAdjustmentViewModel>> GetHistoryARAdjustmentByIdAsync(Int16 CompanyId, Int64 AdjustmentId, string AdjustmentNo, Int16 UserId)
        {
            try
            {
        ...
        public async Task<ARAdjustmentViewModel> GetHistoryARAdjustmentByIdAsync_V1(Int16 CompanyId, Int64 AdjustmentId, string AdjustmentNo, Int16 UserId)
        {
            ARAdjustmentViewModel aRAdjustmentViewModel = new ARAdjustmentViewModel();
            try
            {
