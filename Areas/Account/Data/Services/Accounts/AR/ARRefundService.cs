...
namespace AEMSWEB.Services.Accounts.AR
{
    public sealed class ARRefundService : IARRefundService
    {
        ...
        public async Task<ARRefundViewModelCount> GetARRefundListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<ARRefundViewModel> GetARRefundByIdAsync(Int16 CompanyId, Int64 RefundId, string RefundNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveARRefundAsync(Int16 CompanyId, ArRefundHd arRefundHd, List<ArRefundDt> arRefundDts, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteARRefundAsync(Int16 CompanyId, Int64 RefundId, string RefundNo, string CanacelRemarks, Int16 UserId)
        {
            try
            {
                using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
        ...
        public async Task<IEnumerable<ARRefundViewModel>> GetHistoryARRefundByIdAsync(Int16 CompanyId, Int64 RefundId, string RefundNo, Int16 UserId)
        {
            try
            {
