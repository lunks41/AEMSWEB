...
namespace AEMSWEB.Services.Accounts.AR
{
    public sealed class ARReceiptService : IARReceiptService
    {
        ...
        public async Task<ARReceiptViewModelCount> GetARReceiptListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<ARReceiptViewModel> GetARReceiptByIdAsync(Int16 CompanyId, Int64 ReceiptId, string ReceiptNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveARReceiptAsync(Int16 CompanyId, ArReceiptHd arReceiptHd, List<ArReceiptDt> arReceiptDts, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteARReceiptAsync(Int16 CompanyId, Int64 ReceiptId, string ReceiptNo, string CanacelRemarks, Int16 UserId)
        {
            try
            {
                using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
        ...
        public async Task<IEnumerable<ARReceiptViewModel>> GetHistoryARReceiptByIdAsync(Int16 CompanyId, Int64 ReceiptId, string ReceiptNo, Int16 UserId)
        {
            try
            {
