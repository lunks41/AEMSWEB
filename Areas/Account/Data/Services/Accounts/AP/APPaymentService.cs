...
namespace AEMSWEB.Services.Accounts.AP
{
    public sealed class APPaymentService : IAPPaymentService
    {
        ...
        public async Task<APPaymentViewModelCount> GetAPPaymentListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<APPaymentViewModel> GetAPPaymentByIdAsync(Int16 CompanyId, Int64 PaymentId, string PaymentNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveAPPaymentAsync(Int16 CompanyId, ApPaymentHd arPaymentHd, List<ApPaymentDt> arPaymentDts, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteAPPaymentAsync(Int16 CompanyId, Int64 PaymentId, string PaymentNo, string CanacelRemarks, Int16 UserId)
        {
            try
            {
                using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
        ...
        public async Task<IEnumerable<APPaymentViewModel>> GetHistoryAPPaymentByIdAsync(Int16 CompanyId, Int64 PaymentId, string PaymentNo, Int16 UserId)
        {
            try
            {
