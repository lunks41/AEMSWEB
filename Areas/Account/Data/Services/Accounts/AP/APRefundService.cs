...
namespace AEMSWEB.Services.Accounts.AP
{
    public sealed class APRefundService : IAPRefundService
    {
        ...
        public async Task<APRefundViewModelCount> GetAPRefundListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<APRefundViewModel> GetAPRefundByIdAsync(Int16 CompanyId, Int64 RefundId, string RefundNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveAPRefundAsync(Int16 CompanyId, ApRefundHd arRefundHd, List<ApRefundDt> arRefundDts, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteAPRefundAsync(Int16 CompanyId, Int64 RefundId, string RefundNo, string CanacelRemarks, Int16 UserId)
        {
            try
            {
                using (var TScope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
        ...
        public async Task<IEnumerable<APRefundViewModel>> GetHistoryAPRefundByIdAsync(Int16 CompanyId, Int64 RefundId, string RefundNo, Int16 UserId)
        {
            try
            {
