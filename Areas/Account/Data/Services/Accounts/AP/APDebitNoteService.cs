...
namespace AEMSWEB.Services.Accounts.AP
{
    public sealed class APDebitNoteService : IAPDebitNoteService
    {
        ...
        public async Task<APDebitNoteViewModelCount> GetAPDebitNoteListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<APDebitNoteViewModel> GetAPDebitNoteByIdAsync(Int16 CompanyId, Int64 DebitNoteId, string DebitNoteNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveAPDebitNoteAsync(Int16 CompanyId, ApDebitNoteHd arDebitNoteHd, List<ApDebitNoteDt> arDebitNoteDt, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteAPDebitNoteAsync(Int16 CompanyId, Int64 DebitNoteId, string CanacelRemarks, Int16 UserId)
        {
        ...
        public async Task<IEnumerable<APDebitNoteViewModel>> GetHistoryAPDebitNoteByIdAsync(Int16 CompanyId, Int64 DebitNoteId, string DebitNoteNo, Int16 UserId)
        {
            try
            {
        ...
        public async Task<APDebitNoteViewModel> GetHistoryAPDebitNoteByIdAsync_V1(Int16 CompanyId, Int64 DebitNoteId, string DebitNoteNo, Int16 UserId)
        {
            APDebitNoteViewModel aRDebitNoteViewModel = new APDebitNoteViewModel();
            try
            {
