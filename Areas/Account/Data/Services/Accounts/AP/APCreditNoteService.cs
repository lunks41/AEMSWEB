...
namespace AEMSWEB.Services.Accounts.AP
{
    public sealed class APCreditNoteService : IAPCreditNoteService
    {
        ...
        public async Task<APCreditNoteViewModelCount> GetAPCreditNoteListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<APCreditNoteViewModel> GetAPCreditNoteByIdAsync(Int16 CompanyId, Int64 CreditNoteId, string CreditNoteNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveAPCreditNoteAsync(Int16 CompanyId, ApCreditNoteHd arCreditNoteHd, List<ApCreditNoteDt> arCreditNoteDt, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteAPCreditNoteAsync(Int16 CompanyId, Int64 CreditNoteId, string CanacelRemarks, Int16 UserId)
        {
        ...
        public async Task<IEnumerable<APCreditNoteViewModel>> GetHistoryAPCreditNoteByIdAsync(Int16 CompanyId, Int64 CreditNoteId, string CreditNoteNo, Int16 UserId)
        {
            try
            {
        ...
        public async Task<APCreditNoteViewModel> GetHistoryAPCreditNoteByIdAsync_V1(Int16 CompanyId, Int64 CreditNoteId, string CreditNoteNo, Int16 UserId)
        {
            APCreditNoteViewModel aRCreditNoteViewModel = new APCreditNoteViewModel();
            try
            {
