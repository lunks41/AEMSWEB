...
namespace AEMSWEB.Services.Accounts.AP
{
    public sealed class APInvoiceService : IAPInvoiceService
    {
        ...
        public async Task<APInvoiceViewModelCount> GetAPInvoiceListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<APInvoiceViewModel> GetAPInvoiceByIdNoAsync(Int16 CompanyId, Int64 InvoiceId, string InvoiceNo, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveAPInvoiceAsync(Int16 CompanyId, ApInvoiceHd ApInvoiceHd, List<ApInvoiceDt> ApInvoiceDt, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteAPInvoiceAsync(Int16 CompanyId, Int64 InvoiceId, string CanacelRemarks, Int16 UserId)
        {
        ...
        public async Task<IEnumerable<APInvoiceViewModel>> GetHistoryAPInvoiceByIdAsync(Int16 CompanyId, Int64 InvoiceId, string InvoiceNo, Int16 UserId)
        {
            try
            {
        ...
        public async Task<APInvoiceViewModel> GetHistoryAPInvoiceByIdAsync_V1(Int16 CompanyId, Int64 InvoiceId, string InvoiceNo, Int16 UserId)
        {
            APInvoiceViewModel APInvoiceViewModel = new APInvoiceViewModel();
            try
            {
