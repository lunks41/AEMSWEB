...
namespace AEMSWEB.Services.Accounts.GL
{
    public sealed class GLContraService : IGLContraService
    {
        ...
        public async Task<GLContraViewModel> GetGLContraListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveGLContraAsync(Int16 CompanyId, GLContraHd GLContraHd, List<GLContraDt> GLContraDt, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteGLContraAsync(Int16 CompanyId, Int64 ContraId, string CanacelRemarks, Int16 UserId)
        {
            ...
            try
            {
                ...
                {
                    //Get Invoice Number
                    ContraNo = await _repository.GetQuerySingleOrDefaultAsync<string>($"SELECT ContraNo FROM dbo.GLContraHd WHERE ContraId={ContraId}");
        ...
        public async Task<IEnumerable<GLContraHdViewModel>> GetHistoryGLContraByIdAsync(Int16 CompanyId, Int64 ContraId, string ContraNo, Int16 UserId)
        {
            try
            {
