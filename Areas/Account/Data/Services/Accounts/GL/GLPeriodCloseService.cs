...
namespace AEMSWEB.Services.Accounts.GL
{
    public sealed class GLPeriodCloseService : IGLPeriodCloseService
    {
        ...
        public async Task<IEnumerable<GLPeriodCloseViewModel>> GetGLPeriodCloseListAsync(Int16 CompanyId, Int32 FinYear, Int16 UserId)
        {
            try
            {
        ...
        public async Task<SqlResponse> SaveGLPeriodCloseAsync(Int16 CompanyId, PeriodCloseViewModel periodCloseViewModel, Int16 UserId)
        {
            bool IsEdit = true;
            try
            {
        ...
        public async Task<SqlResponse> GenrateGLPeriodCloseYearlyAsync(Int16 CompanyId, PeriodCloseViewModel periodCloseViewModel, Int16 UserId)
        {
            bool IsEdit = true;
            try
            {
