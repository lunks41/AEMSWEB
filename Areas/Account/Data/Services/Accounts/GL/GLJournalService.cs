...
namespace AEMSWEB.Services.Accounts.GL
{
    public sealed class GLJournalService : IGLJournalService
    {
        ...
        public async Task<GLJournalViewModel> GetGLJournalListAsync(Int16 CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, Int16 UserId)
        {
        ...
        public async Task<SqlResponse> SaveGLJournalAsync(Int16 CompanyId, GLJournalHd GLJournalHd, List<GLJournalDt> GLJournalDt, Int16 UserId)
        {
            bool IsEdit = false;
        ...
        public async Task<SqlResponse> DeleteGLJournalAsync(Int16 CompanyId, Int64 JournalId, string CanacelRemarks, Int16 UserId)
        {
            ...
            try
            {
                ...
                {
                    //Get Invoice Number
                    JournalNo = await _repository.GetQuerySingleOrDefaultAsync<string>($"SELECT JournalNo FROM dbo.GLJournalHd WHERE JournalId={JournalId}");
        ...
        public async Task<IEnumerable<GLJournalHdViewModel>> GetHistoryGLJournalByIdAsync(Int16 CompanyId, Int64 JournalId, string JournalNo, Int16 UserId)
        {
            try
            {
