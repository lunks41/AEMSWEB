...
namespace AEMSWEB.Areas.Account.Data.Services.AP
{
    public sealed class APInvoiceService : IAPInvoiceService
    {
        ...
        public async Task<APInvoiceViewModelCount> GetAPInvoiceListAsync(short CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, short UserId)
        {
