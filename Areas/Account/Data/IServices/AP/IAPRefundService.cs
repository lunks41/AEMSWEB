...
namespace AEMSWEB.Areas.Account.Data.IServices.AP
{
    ...
    {
        public Task<APRefundViewModelCount> GetAPRefundListAsync(short CompanyId, short pageSize, short pageNumber, string searchString, string fromDate, string toDate, short UserId);
