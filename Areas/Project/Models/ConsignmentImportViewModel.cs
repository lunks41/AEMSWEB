...
{
    public class SaveConsignmentImportViewModel
    {
        public ConsignmentImportViewModel consignmentImport { get; set; }
        public string? companyId { get; set; }
    }

    public class ConsignmentImportViewModelCount
    {
        public Int16 responseCode { get; set; }
        public string? responseMessage { get; set; }
        public Int64 totalRecords { get; set; }
        public List<ConsignmentImportViewModel> data { get; set; }
    }

    public class ConsignmentImportViewModel
    {
