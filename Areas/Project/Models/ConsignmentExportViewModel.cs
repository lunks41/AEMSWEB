...
{
    public class SaveConsignmentExportViewModel
    {
        public ConsignmentExportViewModel consignmentExport { get; set; }
        public string? companyId { get; set; }
    }

    public class ConsignmentExportViewModelCount
    {
        public Int16 responseCode { get; set; }
        public string? responseMessage { get; set; }
        public Int64 totalRecords { get; set; }
        public List<ConsignmentExportViewModel> data { get; set; }
    }

    public class ConsignmentExportViewModel
    {
