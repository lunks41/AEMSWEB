...
{
    public class SaveFreshWaterViewModel
    {
        public FreshWaterViewModel freshWater { get; set; }
        public string? companyId { get; set; }
    }

    public class FreshWaterViewModelCount
    {
        public Int16 responseCode { get; set; }
        public string? responseMessage { get; set; }
        public Int64 totalRecords { get; set; }
        public List<FreshWaterViewModel> data { get; set; }
    }

    public class FreshWaterViewModel
    {
